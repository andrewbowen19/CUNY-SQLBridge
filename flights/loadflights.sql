...
LOAD DATA LOCAL INFILE 'Users/andrewbowen/CUNY/data/flights/airlines.csv' 
INTO TABLE airlines 
...
LOAD DATA INFILE 'Users/andrewbowen/CUNY/data/flights/airports.csv' 
INTO TABLE airports
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE  'Users/andrewbowen/CUNY/data/flights/flights.csv' 
INTO TABLE flights
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE  'Users/andrewbowen/CUNY/data/flights/planes.csv' 
INTO TABLE planes
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE 'Users/andrewbowen/CUNY/data/flights/weather.csv' 
INTO TABLE weather
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
